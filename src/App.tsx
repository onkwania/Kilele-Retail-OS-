  ...
  return (
    <Routes>
      <Route element={<Layout />}>
        ...
        <Route
          path="*"
          element={<ErrorState error="This page does not exist. Use the workspace navigation to continue." />}
        />
      </Route>
    </Routes>
  );
  ...
  return (
    <ToastProvider>
      <AuthProvider>
        <BrowserRouter>
          <Routes>
            {/* An invitation link is opened by somebody with no account yet, so it sits outside the
                session gate. The token in the URL is the credential; it is single-use and expires. */}
